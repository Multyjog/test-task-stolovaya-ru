...
!function(a, b) {
    ...
    var c, d, e, f = a, g = f.document, h = f.navigator, i = f.setTimeout, j = f.clearTimeout, k = f.setInterval, l = f.clearInterval, m = f.getComputedStyle, n = f.encodeURIComponent, o = f.ActiveXObject, p = f.Error, q = f.Number.parseInt || f.parseInt, r = f.Number.parseFloat || f.parseFloat, s = f.Number.isNaN || f.isNaN, t = f.Date.now, u = f.Object.keys, v = f.Object.prototype.hasOwnProperty, w = f.Array.prototype.slice, x = function() {
        ...
        var a, c, d, e, f, g, h = y(arguments), i = h[0] || {};
        for (a = 1,
        c = h.length; c > a; a++)
            if (null != (d = h[a]))
                for (e in d)
        ...
        if ("object" != typeof a || null == a || "number" == typeof a.nodeType)
            ...
            c = 0,
            d = a.length; d > c; c++)
                v.call(a, c) && (b[c] = A(a[c]));
        else {
            b = {};
            for (e in a)
                v.call(a, e) && (b[e] = A(a[e]))
        }
        return b
    }, B = function(a, b) {
        ...
        return b && (a = b.sourceURL || b.fileName || G(b.stack)),
        a
    }, I = function() {
        var a, c, d;
        if (g.currentScript && (a = g.currentScript.src))
            return a;
        if (c = g.getElementsByTagName("script"),
        1 === c.length)
            return c[0].src || b;
        if ("readyState"in (c[0] || document.createElement("script")))
            for (d = c.length; d--; )
                if ("interactive" === c[d].readyState && (a = c[d].src))
                    return a;
        return "loading" === g.readyState && (a = c[c.length - 1].src) ? a : (a = H()) ? a : b
    }, J = function() {
        ...
        return null == f.opener && (!!f.top && f != f.top || !!f.parent && f != f.parent)
    }(), N = "html" === g.documentElement.nodeName, O = {
        bridge: null,
        version: "0.0.0",
        pluginType: "unknown",
        sandboxed: null,
    ...
    }, W = ["flash-unavailable", "flash-degraded", "flash-overdue", "version-mismatch", "config-mismatch", "clipboard-error"], X = ["flash-sandboxed", "flash-disabled", "flash-outdated", "flash-insecure", "flash-unavailable", "flash-degraded", "flash-deactivated", "flash-overdue"], Y = new RegExp("^flash-(" + X.map(function(a) {
        return a.replace(/^flash-/, "")
    }).join("|") + ")$"), Z = new RegExp("^flash-(" + X.filter(function(a) {
        return "flash-disabled" !== a
    }).map(function(a) {
        return a.replace(/^flash-/, "")
    }).join("|") + ")$"), $ = {
        swfPath: K(),
        trustedDomains: f.location.host ? [f.location.host] : [],
        cacheBust: !0,
        ...
        "object" != typeof a || !a || "length"in a || u(a).forEach(function(b) {
            if (/^(?:forceHandCursor|title|zIndex|bubbleEvents|fixLineEndings)$/.test(b))
                $[b] = a[b];
        ...
        return Ya(),
        {
            browser: z(B(h, ["userAgent", "platform", "appName", "appVersion"]), {
                isSupported: ba()
            }),
            flash: C(O, ["bridge"]),
            zeroclipboard: {
        ...
        return !!(g.addEventListener && f.Object.keys && f.Array.prototype.map)
    }, ca = function() {
        return !!(O.sandboxed || O.disabled || O.outdated || O.unavailable || O.degraded || O.deactivated)
    }, da = function(a, d) {
        var e, f, g, h = {};
        if ("string" == typeof a && a ? g = a.toLowerCase().split(/\s+/) : "object" != typeof a || !a || "length"in a || "undefined" != typeof d || u(a).forEach(function(b) {
            var c = a[b];
            "function" == typeof c && $a.on(b, c)
        }),
        g && g.length && d) {
            for (e = 0,
            f = g.length; f > e; e++)
        ...
        var c, d, e, f, g;
        if (0 === arguments.length ? f = u(Q) : "string" == typeof a && a ? f = a.toLowerCase().split(/\s+/) : "object" != typeof a || !a || "length"in a || "undefined" != typeof b || u(a).forEach(function(b) {
            var c = a[b];
            "function" == typeof c && $a.off(b, c)
        }),
        f && f.length)
            for (c = 0,
            d = f.length; d > c; c++)
        ...
        var b;
        return b = "string" == typeof a && a ? A(Q[a]) || null : A(Q)
    }, ga = function(a) {
        var b, c, d;
        return a = ra(a),
        a && !ya(a) ? "ready" === a.type && O.overdue === !0 ? $a.emit({
            type: "error",
            name: "flash-overdue"
        }) : (b = z({}, a),
        wa.call(this, b),
        ...
        var a = $.swfPath || ""
          , b = a.slice(0, 2)
          , c = a.slice(0, a.indexOf("://") + 1);
        return "\\\\" === b ? "file:" : "//" === b || "" === c ? f.location.protocol : c
    }, ia = function() {
        var a, b, c = O.sandboxed;
        return ba() ? (Ya(),
        "boolean" != typeof O.ready && (O.ready = !1),
        void (O.sandboxed !== c && O.sandboxed === !0 ? (O.ready = !1,
        $a.emit({
            type: "error",
            name: "flash-sandboxed"
        })) : $a.isFlashUnusable() || null !== O.bridge || (b = ha(),
        b && b !== f.location.protocol ? $a.emit({
            type: "error",
            name: "flash-insecure"
        }) : (a = $.flashLoadTimeout,
        "number" == typeof a && a >= 0 && (T = i(function() {
            "boolean" != typeof O.deactivated && (O.deactivated = !0),
            O.deactivated === !0 && $a.emit({
                type: "error",
        ...
        for (var d in c)
            "string" == typeof d && d && v.call(c, d) && "string" == typeof c[d] && c[d] && (R[d] = Xa(c[d]))
    }, la = function(a) {
        "undefined" == typeof a ? (D(R),
        S = null) : "string" == typeof a && v.call(R, a) && delete R[a]
    }, ma = function(a) {
        return "undefined" == typeof a ? A(R) : "string" == typeof a && v.call(R, a) ? R[a] : void 0
    }, na = function(a) {
        if (a && 1 === a.nodeType) {
            d && (Pa(d, $.activeClass),
            d !== a && Pa(d, $.hoverClass)),
            ...
            var e = $.forceHandCursor === !0 || "pointer" === Qa(a, "cursor");
            Va(e),
            Ua()
        }
    }, oa = function() {
        ...
        b) {
            b = b.toLowerCase(),
            !a.target && (/^(copy|aftercopy|_click)$/.test(b) || "error" === b && "clipboard-error" === a.name) && (a.target = e),
            z(a, {
                type: b,
            ...
            var c = V[a.type];
            return "error" === a.type && a.name && c && (c = c[a.name]),
            c && (a.message = c),
            "ready" === a.type && z(a, {
                target: null,
                version: O.version
            }),
            "error" === a.type && (Y.test(a.name) && z(a, {
                target: null,
                minimumVersion: P
            }),
            Z.test(a.name) && z(a, {
            ...
            "flash-insecure" === a.name && z(a, {
                pageProtocol: f.location.protocol,
                swfProtocol: ha()
            })),
            ...
            "aftercopy" === a.type && (a = Ia(a, S)),
            a.target && !a.relatedTarget && (a.relatedTarget = sa(a.target)),
            ta(a)
        }
    }, sa = function(a) {
        ...
        if ("object" == typeof a && a && a.type) {
            ...
            if (e && e.length) {
                ...
                h = e.length; h > g; g++)
                    i = e[g],
                    j = l,
                    "string" == typeof i && "function" == typeof f[i] && (i = f[i]),
                    "object" == typeof i && i && "function" == typeof i.handleEvent && (j = i,
                    i = i.handleEvent),
                    "function" == typeof i && (k = z({}, a),
                    va(i, j, [k], b))
            }
            return this
        }
        ...
        var b = null;
        return (M === !1 || a && "error" === a.type && a.name && -1 !== W.indexOf(a.name)) && (b = !1),
        b
    }, ya = function(a) {
        var b = a.target || d || null
          , f = "swf" === a._source;
        switch (delete a._source,
        a.type) {
        case "error":
            var g = "flash-sandboxed" === a.name || xa(a);
            "boolean" == typeof g && (O.sandboxed = g),
            "browser-unsupported" === a.name ? z(O, {
                disabled: !1,
                outdated: !1,
                unavailable: !1,
                degraded: !1,
                ...
                ready: !1
            }) : "version-mismatch" === a.name && (c = a.swfVersion,
            z(O, {
                disabled: !1,
                outdated: !1,
                insecure: !1,
        ...
        case "copy":
            ...
            !R["text/html"] && !R["text/plain"] && k && (j = k.value || k.outerHTML || k.innerHTML) && (i = k.value || k.textContent || k.innerText) ? (a.clipboardData.clearData(),
            a.clipboardData.setData("text/plain", i),
            j !== i && a.clipboardData.setData("text/html", j)) : !R["text/plain"] && a.target && (i = a.target.getAttribute("data-clipboard-text")) && (a.clipboardData.clearData(),
            a.clipboardData.setData("text/plain", i));
            break;
        case "aftercopy":
            za(a),
            $a.clearData(),
            b && b !== Na() && b.focus && b.focus();
            break;
        case "_mouseover":
            $a.focus(b),
            $.bubbleEvents === !0 && f && (b && b !== a.relatedTarget && !E(a.relatedTarget, b) && Aa(z({}, a, {
                type: "mouseenter",
                bubbles: !1,
                cancelable: !1
            })),
        ...
        var a, b = O.bridge, c = Da(b);
        if (!b) {
            var d = Ma(f.location.host, $)
              , e = "never" === d ? "none" : "all"
              , h = Ka(z({
                jsVersion: $a.version
            }, $))
              , i = $.swfPath + Ja($.swfPath, $);
            N && (i = Ea(i)),
            c = Ca();
            ...
            k.innerHTML = '<object id="' + $.swfObjectId + '" name="' + $.swfObjectId + '" width="100%" height="100%" ' + (l ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : 'type="application/x-shockwave-flash" data="' + i + '"') + ">" + (l ? '<param name="movie" value="' + i + '"/>' : "") + '<param name="allowScriptAccess" value="' + d + '"/><param name="allowNetworking" value="' + e + '"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><param name="flashvars" value="' + h + '"/><div id="' + $.swfObjectId + '_fallbackContent">&nbsp;</div></object>',
            b = k.firstChild,
            k = null,
            x(b).ZeroClipboard = $a,
            c.replaceChild(b, j),
        ...
        if (a) {
            var d = Da(a);
            d && ("activex" === O.pluginType && "readyState"in a ? (a.style.display = "none",
            function e() {
                if (4 === a.readyState) {
                    for (var b in a)
        ...
        if ("object" == typeof a && a) {
            for (var d in a)
                if (d && v.call(a, d) && "string" == typeof a[d] && a[d])
        ...
        for (var d in a)
            if (v.call(a, d))
                if ("errors" === d) {
                    ...
                    var g = a[d];
                    for (var h in g)
                        h && v.call(g, h) && v.call(b, h) && (c[d][b[h]] = g[h])
                }
        return c
    }, Ja = function(a, b) {
        ...
        e && e.length)
            for (b = 0,
            c = e.length; c > b; b++)
                if (v.call(e, b) && e[b] && "string" == typeof e[b]) {
                    if (d = La(e[b]),
                    !d)
                        continue;
                    if ("*" === d) {
        ...
        return h.length && (g += "trustedOrigins=" + n(h.join(","))),
        ...
        var c, d, e, f = [];
        if ("string" == typeof b && b && (f = b.split(/\s+/)),
        a && 1 === a.nodeType && f.length > 0) {
            for (e = (" " + (a.className || "") + " ").replace(/[\t\r\n\f]/g, " "),
            c = 0,
            d = f.length; d > c; c++)
                -1 === e.indexOf(" " + f[c] + " ") && (e += f[c] + " ");
            e = e.replace(/^\s+|\s+$/g, ""),
            e !== a.className && (a.className = e)
        }
        return a
    }, Pa = function(a, b) {
        var c, d, e, f = [];
        if ("string" == typeof b && b && (f = b.split(/\s+/)),
        a && 1 === a.nodeType && f.length > 0 && a.className) {
            for (e = (" " + a.className + " ").replace(/[\t\r\n\f]/g, " "),
            c = 0,
            d = f.length; d > c; c++)
                e = e.replace(" " + f[c] + " ", " ");
        ...
        if (a.getBoundingClientRect) {
            var c = a.getBoundingClientRect()
              ...
              , j = 0
              , k = 0;
            if ("relative" === Qa(g.body, "position")) {
            ...
            b.left = c.left + d - h - j,
            b.top = c.top + e - i - k,
            b.width = "width"in c ? c.width : c.right - c.left,
        ...
        if (/^(?:auto|inherit)$/.test(a))
            return a;
        var b;
        return "number" != typeof a || s(a) ? "string" == typeof a && (b = Wa(q(a, 10))) : b = a,
        "number" == typeof b ? b : "auto"
    }, Xa = function(a) {
        var b = /(\r\n|\r|\n)/g;
        return "string" == typeof a && $.fixLineEndings === !0 && (L() ? /((^|[^\r])\n|\r([^\n]|$))/.test(a) && (a = a.replace(b, "\r\n")) : /\r/.test(a) && (a = a.replace(b, "\n"))),
        a
    }, Ya = function(b) {
        var c, d, e, f = O.sandboxed, g = null;
        if (b = b === !0,
        M === !1)
            g = !1;
        else {
        ...
        if (h.plugins && h.plugins.length)
            e = h.plugins["Shockwave Flash"],
            d(e),
            h.plugins["Shockwave Flash 2.0"] && (i = !0,
            l = "2.0.0.11");
        else if (h.mimeTypes && h.mimeTypes.length)
            g = h.mimeTypes["application/x-shockwave-flash"],
            e = g && g.enabledPlugin,
            d(e);
            ...
            try {
                ...
                try {
                    f = new a("ShockwaveFlash.ShockwaveFlash.6"),
                    i = !0,
                    l = "6.0.21"
                } catch (n) {
                    try {
        ...
        O.disabled = i !== !0,
        O.outdated = l && r(l) < r(P),
        O.version = l || "0.0.0",
        O.pluginType = k ? "pepper" : j ? "activex" : i ? "netscape" : "unknown"
    };
    Za(o),
    Ya(!0);
    var $a = function() {
        return this instanceof $a ? void ("function" == typeof $a._createClient && $a._createClient.apply(this, y(arguments))) : new $a
    };
    $a.version = "2.4.0-beta.1",
    $a.config = function() {
        return _.apply(this, y(arguments))
    }
    ,
    $a.state = function() {
        return aa.apply(this, y(arguments))
    }
    ,
    $a.isFlashUnusable = function() {
        return ca.apply(this, y(arguments))
    }
    ,
    $a.on = function() {
        return da.apply(this, y(arguments))
    }
    ,
    $a.off = function() {
        return ea.apply(this, y(arguments))
    }
    ,
    $a.handlers = function() {
        return fa.apply(this, y(arguments))
    }
    ,
    $a.emit = function() {
        return ga.apply(this, y(arguments))
    }
    ,
    $a.create = function() {
        return ia.apply(this, y(arguments))
    }
    ,
    $a.destroy = function() {
        return ja.apply(this, y(arguments))
    }
    ,
    $a.setData = function() {
        return ka.apply(this, y(arguments))
    }
    ,
    $a.clearData = function() {
        return la.apply(this, y(arguments))
    }
    ,
    $a.getData = function() {
        return ma.apply(this, y(arguments))
    }
    ,
    $a.focus = $a.activate = function() {
        return na.apply(this, y(arguments))
    }
    ,
    $a.blur = $a.deactivate = function() {
        return oa.apply(this, y(arguments))
    }
    ,
    $a.activeElement = function() {
        return pa.apply(this, y(arguments))
    }
    ;
    var _a = 0
      , ab = {}
    ...
    var eb = function(a) {
        ...
        b = {
            ...
            elements: [],
            handlers: {},
            coreWildcardHandler: function(a) {
                return c.emit(a)
            }
        },
        ab[c.id] = b,
        a && c.clip(a),
        $a.on("*", b.coreWildcardHandler),
      ...
      , fb = function(a, d) {
        var e, f, g, h = {}, i = this, j = ab[i.id], k = j && j.handlers;
        if (!j)
            throw new Error("Attempted to add new listener(s) to a destroyed ZeroClipboard client instance");
        if ("string" == typeof a && a ? g = a.toLowerCase().split(/\s+/) : "object" != typeof a || !a || "length"in a || "undefined" != typeof d || u(a).forEach(function(b) {
            var c = a[b];
            "function" == typeof c && i.on(b, c)
        }),
        g && g.length && d) {
            for (e = 0,
            f = g.length; f > e; e++)
      ...
      , gb = function(a, b) {
        var c, d, e, f, g, h = this, i = ab[h.id], j = i && i.handlers;
        if (!j)
            return h;
        if (0 === arguments.length ? f = u(j) : "string" == typeof a && a ? f = a.split(/\s+/) : "object" != typeof a || !a || "length"in a || "undefined" != typeof b || u(a).forEach(function(b) {
            var c = a[b];
            "function" == typeof c && h.off(b, c)
        }),
        f && f.length)
            for (c = 0,
            d = f.length; d > c; c++)
      ...
      , hb = function(a) {
        var b = null
          , c = ab[this.id] && ab[this.id].handlers;
        return c && (b = "string" == typeof a && a ? c[a] ? c[a].slice(0) : [] : A(c)),
        b
    }
      , ib = function(a) {
        var b, c = this;
        return nb.call(c, a) && ("object" == typeof a && a && "string" == typeof a.type && a.type && (a = z({}, a)),
        b = z({}, ra(a), {
            client: c
        }),
        ob.call(c, b)),
      ...
      , jb = function(a) {
        ...
        for (var b = 0; b < a.length; b++)
            if (v.call(a, b) && a[b] && 1 === a[b].nodeType) {
                a[b].zcClippingId ? -1 === cb[a[b].zcClippingId].indexOf(this.id) && cb[a[b].zcClippingId].push(this.id) : (a[b].zcClippingId = "zcClippingId_" + bb++,
                cb[a[b].zcClippingId] = [this.id],
                $.autoActivate === !0 && qb(a[b]));
                var c = ab[this.id] && ab[this.id].elements;
      ...
      , kb = function(a) {
        ...
        if (!b)
            return this;
        var c, d = b.elements;
        a = "undefined" == typeof a ? d.slice(0) : pb(a);
        for (var e = a.length; e--; )
            if (v.call(a, e) && a[e] && 1 === a[e].nodeType) {
                for (c = 0; -1 !== (c = d.indexOf(a[e], c)); )
                    d.splice(c, 1);
                var f = cb[a[e].zcClippingId];
                if (f) {
                    for (c = 0; -1 !== (c = f.indexOf(this.id, c)); )
                        f.splice(c, 1);
                    0 === f.length && ($.autoActivate === !0 && rb(a[e]),
        ...
        if ("object" == typeof a && a && a.type && b) {
            ...
            if (g && g.length) {
                ...
                i = g.length; i > h; h++)
                    j = g[h],
                    k = m,
                    "string" == typeof j && "function" == typeof f[j] && (j = f[j]),
                    "object" == typeof j && j && "function" == typeof j.handleEvent && (k = j,
                    j = j.handleEvent),
                    "function" == typeof j && (l = z({}, a),
                    va(j, k, [l], c))
            }
        }
    }
      ...
      , qb = function(a) {
        if (a && 1 === a.nodeType) {
            var b = function(a) {
                (a || (a = f.event)) && ("js" !== a._source && (a.stopImmediatePropagation(),
                a.preventDefault()),
                delete a._source)
            }
              , c = function(c) {
      ...
      , rb = function(a) {
        if (a && 1 === a.nodeType) {
            var b = db[a.zcClippingId];
            if ("object" == typeof b && b) {
                for (var c, d, e = ["move", "leave", "enter", "out", "over"], f = 0, g = e.length; g > f; f++)
                    c = "mouse" + e[f],
                    d = b[c],
                    "function" == typeof d && a.removeEventListener(c, d, !1);
                delete db[a.zcClippingId]
            }
        }
    };
    $a._createClient = function() {
        eb.apply(this, y(arguments))
    }
    ,
    $a.prototype.on = function() {
        return fb.apply(this, y(arguments))
    }
    ,
    $a.prototype.off = function() {
        return gb.apply(this, y(arguments))
    }
    ,
    $a.prototype.handlers = function() {
        return hb.apply(this, y(arguments))
    }
    ,
    $a.prototype.emit = function() {
        return ib.apply(this, y(arguments))
    }
    ,
    $a.prototype.clip = function() {
        return jb.apply(this, y(arguments))
    }
    ,
    $a.prototype.unclip = function() {
        return kb.apply(this, y(arguments))
    }
    ,
    $a.prototype.elements = function() {
        return lb.apply(this, y(arguments))
    }
    ,
    $a.prototype.destroy = function() {
        return mb.apply(this, y(arguments))
    }
    ,
    $a.prototype.setText = function(a) {
        if (!ab[this.id])
            throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
        return $a.setData("text/plain", a),
        this
    }
    ,
    $a.prototype.setHtml = function(a) {
        if (!ab[this.id])
            throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
        return $a.setData("text/html", a),
        this
    }
    ,
    $a.prototype.setRichText = function(a) {
        if (!ab[this.id])
            throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
        return $a.setData("application/rtf", a),
        this
    }
    ,
    $a.prototype.setData = function() {
        if (!ab[this.id])
            throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
        return $a.setData.apply(this, y(arguments)),
        this
    }
    ,
    $a.prototype.clearData = function() {
        ...
        return $a.clearData.apply(this, y(arguments)),
        this
    }
    ,
    $a.prototype.getData = function() {
        ...
        return $a.getData.apply(this, y(arguments))
    }
    ,
    "function" == typeof define && define.amd ? define(function() {
        return $a
    }) : "object" == typeof module && module && "object" == typeof module.exports && module.exports ? module.exports = $a : a.ZeroClipboard = $a
}(function() {
    return this || window
}());
